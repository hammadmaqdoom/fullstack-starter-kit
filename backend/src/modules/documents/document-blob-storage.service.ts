...
/**
 * Blob storage for generated HR documents (issued PDFs, letterhead previews).
 * Mirrors `EsignBlobStorageService`'s S3-primary / local-fallback pattern so
 * uploads work in dev (no AWS creds) and production without branching in callers.
 */
@Injectable()
export class DocumentBlobStorageService {
